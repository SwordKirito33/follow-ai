...
function StatCard({ label, value, icon }: { label: string; value: number | string; icon: string }) {
  return (
    <div className="bg-slate-800/50 dark:bg-gray-800 rounded-xl p-4 border border-white/10 dark:border-gray-700 text-center">
...
export function ProfileSystem({
  ...
  return (
    <div className={cn('bg-slate-800/50 dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden', className)}>
      {/* Header */}
      <ProfileHeader
        profile={profile}
