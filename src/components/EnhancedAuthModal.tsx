        ...
        <div className="hidden md:flex w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 p-8 flex-col justify-between text-white">
          ...
          <div className="space-y-4">
            {features.map((feature, index) => (
              ...
              >
                <div className="p-2 bg-gray-800/20 rounded-lg">{feature.icon}</div>
            ...
            <>
              <div className="grid grid-cols-2 gap-3 mb-6">
                <button
                  ...
                  disabled={isLoading}
                  className="flex items-center justify-center gap-2 py-3 border border-white/10 dark:border-gray-700 rounded-xl hover:bg-gray-800/5 dark:hover:bg-gray-800 transition-colors"
                >
