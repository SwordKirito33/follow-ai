        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 py-3 border-b border-white/10 dark:border-gray-700">
            ...
            <input
              ...
              autoFocus
            />
            <kbd className="px-2 py-1 text-xs font-semibold text-gray-400 bg-gray-800/10 dark:bg-gray-800 rounded border border-white/20 dark:border-gray-600">
              ESC
            </kbd>
          </div>
                    ...
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 text-left transition-colors ${
                        isSelected
                          ...
                          : 'text-white dark:text-gray-100 hover:bg-gray-800/5 dark:hover:bg-gray-800'
                      }`}
                    >
          ...
          {/* Footer */}
          <div className="px-4 py-2 border-t border-white/10 dark:border-gray-700 bg-gray-800/5 dark:bg-gray-800/50 flex items-center justify-between text-xs text-gray-400">
