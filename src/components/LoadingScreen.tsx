...
export const ContentSkeleton: React.FC<{ lines?: number }> = ({ lines = 3 }) => (
  <div className="space-y-3 animate-pulse">
    {Array.from({ length: lines }).map((_, i) => (
      <div
        key={i}
        className="h-4 bg-gray-800/10 dark:bg-gray-700 rounded"
...
export const CardSkeleton: React.FC = () => (
  <div className="bg-gray-900/90 backdrop-blur-sm rounded-xl p-6 shadow-sm border border-white/10 dark:border-gray-700 animate-pulse">
    <div className="flex items-center gap-4 mb-4">
      <div className="w-12 h-12 bg-gray-800/10 dark:bg-gray-700 rounded-full" />
      <div className="flex-1 space-y-2">
        <div className="h-4 bg-gray-800/10 dark:bg-gray-700 rounded w-3/4" />
        <div className="h-3 bg-gray-800/10 dark:bg-gray-700 rounded w-1/2" />
      </div>
    </div>
    <div className="space-y-2">
      <div className="h-3 bg-gray-800/10 dark:bg-gray-700 rounded" />
      <div className="h-3 bg-gray-800/10 dark:bg-gray-700 rounded w-5/6" />
    </div>
  </div>
);
