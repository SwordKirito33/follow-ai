  ...
  return (
    <nav
      className={cn(
        ...
        sticky && 'sticky top-0',
        transparent ? 'bg-transparent' : 'bg-slate-800/50 dark:bg-gray-900 shadow-sm',
        className
      )}
    >
  ...
  if (item.children) {
    return (
      <div ref={dropdownRef} className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute top-full left-0 mt-1 w-48 bg-slate-800/50 dark:bg-gray-800 rounded-lg shadow-lg border border-white/10 dark:border-gray-700 py-2 z-50">
...
export function Sidebar({
  ...
  return (
    <aside
      className={cn(
        'h-screen bg-slate-800/50 dark:bg-gray-900 border-r border-white/10 dark:border-gray-800 flex flex-col transition-all duration-300',
        collapsed ? 'w-16' : 'w-64',
        className
      )}
    >
