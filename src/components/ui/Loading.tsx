...
export function LoadingOverlay({
  ...
  const overlayClasses = cn(
    ...
    fullScreen
      ? 'fixed inset-0 z-50 bg-gray-800/80 dark:bg-gray-900/80'
      : 'absolute inset-0 z-10 bg-gray-800/60 dark:bg-gray-900/60',
...
export function Skeleton({ className, animate = true }: SkeletonProps) {
  return (
    <div
      className={cn(
        'bg-gray-800/10 dark:bg-gray-700 rounded',
...
export function SkeletonTable({ rows = 5, cols = 4 }: { rows?: number; cols?: number }) {
  return (
    <div className="border rounded-lg overflow-hidden">
      {/* Header */}
      <div className="flex gap-4 p-4 bg-gray-800/5 dark:bg-gray-800 border-b">
...
export function ProgressLoading({
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full h-2 bg-gray-800/10 dark:bg-gray-700 rounded-full overflow-hidden">
        <div
