...
const Skeleton: React.FC<SkeletonProps> = ({
  ...
  const baseClasses = 'bg-white/10 dark:bg-gray-700';
...
export const SkeletonCard: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`bg-white dark:bg-gray-900 rounded-xl p-4 shadow-sm border border-white/10 dark:border-gray-700 ${className}`}>
  ...
  <div className={`space-y-6 ${className}`}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="bg-white dark:bg-gray-900 rounded-xl p-4 shadow-sm border border-white/10 dark:border-gray-700">
    ...
    {/* Chart */}
    <div className="bg-white dark:bg-gray-900 rounded-xl p-4 shadow-sm border border-white/10 dark:border-gray-700">
