          ...
          <div className="px-6 pb-6 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              {!isFirstStep && (
                <button
                  onClick={handlePrev}
                  className="px-4 py-2 border border-white/20 dark:border-gray-600 rounded-xl text-gray-300 dark:text-gray-300 font-medium flex items-center gap-1 hover:bg-gray-800/5 dark:hover:bg-gray-800 transition-colors"
                >
