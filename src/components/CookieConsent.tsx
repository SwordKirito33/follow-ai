                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <button
                        ...
                        className="px-6 py-2.5 bg-gray-800/10 dark:bg-gray-800 text-gray-300 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-800/10 dark:hover:bg-gray-700 transition-colors"
                      >
                        Reject All
                      </button>
                      <button
              ...
              <div>
                ...
                <div className="p-6 space-y-4 max-h-80 overflow-y-auto">
                  {cookieTypes.map((type) => (
                    <div
                      key={type.key}
                      className="flex items-start justify-between gap-4 p-4 bg-gray-800/5 dark:bg-gray-800 rounded-xl"
                    >
                      <div>
