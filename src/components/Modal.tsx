      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          >
            ...
            {(title || showCloseButton) && (
              <div className="flex items-start justify-between p-6 border-b border-white/10 dark:border-gray-700">
                ...
                {showCloseButton && (
                  <button
                    onClick={onClose}
                    className="p-2 -mr-2 -mt-2 text-gray-400 hover:text-gray-400 dark:hover:text-gray-300 hover:bg-gray-800/10 dark:hover:bg-gray-800 rounded-lg transition-colors"
                  >
                    <X className="w-5 h-5" />
                  </button>
                )}
            ...
            {/* Footer */}
            {footer && (
              <div className="p-6 border-t border-white/10 dark:border-gray-700 bg-gray-800/5 dark:bg-gray-800/50">
                {footer}
              </div>
            )}
          </motion.div>
      ...
      footer={
        <div className="flex justify-end gap-3">
          <button
            onClick={onClose}
            disabled={isLoading}
            className="px-4 py-2 text-gray-300 dark:text-gray-300 font-medium hover:bg-gray-800/10 dark:hover:bg-gray-700 rounded-lg transition-colors"
          >
            {cancelText}
          </button>
          <button
