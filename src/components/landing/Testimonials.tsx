      ...
      <div className="container mx-auto px-4">
        ...
        {layout === 'carousel' && (
          <div className="relative max-w-3xl mx-auto">
            ...
            <button
              onClick={goToPrev}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-10 h-10 rounded-full bg-slate-800/50 dark:bg-gray-800 shadow-lg flex items-center justify-center hover:bg-gray-800/5 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <button
              onClick={goToNext}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-10 h-10 rounded-full bg-slate-800/50 dark:bg-gray-800 shadow-lg flex items-center justify-center hover:bg-gray-800/5 dark:hover:bg-gray-700 transition-colors"
            >
              <svg className="w-5 h-5 text-gray-400 dark:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
