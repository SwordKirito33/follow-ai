        ...
        <div className="container mx-auto px-4">
          <div className="relative -mt-20 flex flex-col md:flex-row md:items-end gap-4">
            <div className="relative">
              ...
              />
              {isOwnProfile && (
                <button className="absolute bottom-2 right-2 p-2 bg-gray-800/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-slate-800/50/10 dark:hover:bg-gray-700 transition-colors">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex gap-2">
                  {isOwnProfile ? (
                    <>
                      <button
                        ...
                        className="px-4 py-2 bg-gray-800/90 backdrop-blur-sm border border-white/10 dark:border-gray-700 rounded-xl font-medium flex items-center gap-2 hover:bg-slate-800/50/5 dark:hover:bg-gray-700 transition-colors"
                      >
                        <Edit2 className="w-4 h-4" />
                        Edit Profile
                      </button>
                      <button className="p-2 bg-gray-800/90 backdrop-blur-sm border border-white/10 dark:border-gray-700 rounded-xl hover:bg-slate-800/50/5 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <button
                      ...
                      className={`px-6 py-2 rounded-xl font-medium flex items-center gap-2 transition-all ${
                        isFollowing
                          ? 'bg-slate-800/50/10 dark:bg-gray-800 text-gray-300 dark:text-gray-300'
                  ...
                  <button
                    ...
                    className="p-2 bg-gray-800/90 backdrop-blur-sm border border-white/10 dark:border-gray-700 rounded-xl hover:bg-slate-800/50/5 dark:hover:bg-gray-700 transition-colors"
                  >
          ...
          <div className="space-y-6">
                ...
                <div className="flex gap-3 mt-4 pt-4 border-t border-white/10 dark:border-gray-700">
                  {profile.twitter && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 bg-slate-800/50/10 dark:bg-gray-800 rounded-lg hover:bg-slate-800/50/10 dark:hover:bg-gray-700 transition-colors"
                    >
            ...
            <div className="bg-gray-900/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-slate-800/50/5 dark:bg-gray-800 rounded-xl">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      {profile.badges.length > 6 && (
                        <button
                          ...
                          className="p-3 rounded-xl bg-slate-800/50/10 dark:bg-gray-800 text-gray-400 dark:text-gray-400 font-medium"
                        >
                ...
                >
                  ...
                  <div className="space-y-4">
                    {profile.recentActivity.map((activity) => (
                      <div
                        key={activity.id}
                        className="flex items-start gap-4 p-4 bg-slate-800/50/5 dark:bg-gray-800 rounded-xl"
                      >
