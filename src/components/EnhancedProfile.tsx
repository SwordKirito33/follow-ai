                  ...
                  {isOwnProfile ? (
                    ...
                    <button
                      ...
                      className={`px-6 py-2 rounded-xl font-medium flex items-center gap-2 transition-all ${
                        isFollowing
                          ? 'bg-white/10 dark:bg-gray-800 text-gray-300 dark:text-gray-300'
                ...
                <div className="flex gap-3 mt-4 pt-4 border-t border-white/10 dark:border-gray-700">
                  {profile.twitter && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 bg-white/10 dark:bg-gray-800 rounded-lg hover:bg-white/10 dark:hover:bg-gray-700 transition-colors"
                    >
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      {profile.badges.length > 6 && (
                        <button
                          ...
                          className="p-3 rounded-xl bg-white/10 dark:bg-gray-800 text-gray-400 dark:text-gray-400 font-medium"
                        >
                ...
                >
                  ...
                  <div className="space-y-4">
                    {profile.recentActivity.map((activity) => (
                      <div
                        key={activity.id}
                        className="flex items-start gap-4 p-4 bg-white/5 dark:bg-gray-800 rounded-xl"
                      >
