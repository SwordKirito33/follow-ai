        ...
        <div className="container mx-auto px-4">
          <div className="relative -mt-20 flex flex-col md:flex-row md:items-end gap-4">
            <div className="relative">
              ...
              />
              {isOwnProfile && (
                <button className="absolute bottom-2 right-2 p-2 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  <Camera className="w-4 h-4 text-gray-600 dark:text-gray-400" />
                </button>
              )}
              {/* Level badge */}
              <div className="absolute -bottom-2 -right-2 px-3 py-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full text-sm font-bold shadow-lg">
                Lv.{profile.level}
              </div>
            </div>
                  ...
                  {isOwnProfile ? (
                    <>
                      <button
                        ...
                        className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl font-medium flex items-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                      >
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      {profile.badges.length > 6 && (
                        <button
                          ...
                          className="p-3 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 font-medium"
                        >
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {profile.badges.map((badge) => (
                      <div
                        key={badge.id}
                        className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow"
                      >
                    ...
                    {profile.recentActivity.map((activity) => (
                      ...
                      >
                        <div className={`p-2 rounded-lg ${
                          ...
                          activity.type === 'level_up' ? 'bg-blue-100 dark:bg-blue-900/30' :
                          activity.type === 'badge_earned' ? 'bg-purple-100 dark:bg-purple-900/30' :
                          'bg-orange-100 dark:bg-orange-900/30'
                        }`}>
                          {activity.type === 'task_completed' && <CheckCircle className="w-5 h-5 text-green-600" />}
                          {activity.type === 'level_up' && <TrendingUp className="w-5 h-5 text-blue-600" />}
                          {activity.type === 'badge_earned' && <Award className="w-5 h-5 text-purple-600" />}
                        ...
                        <div className="flex-1">
                          ...
                          {activity.xp && (
                            <p className="text-sm text-blue-600">+{activity.xp} XP</p>
                          )}
                        </div>
