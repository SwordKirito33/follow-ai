      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <div className="flex-1 px-4 py-3 bg-gray-800/10 dark:bg-gray-800 rounded-lg font-mono text-lg font-bold text-white dark:text-white">
              {inviteCode}
            </div>
            <button
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              value={inviteUrl}
              readOnly
              className="flex-1 px-4 py-3 bg-gray-800/10 dark:bg-gray-800 rounded-lg text-sm text-gray-300 dark:text-gray-300 truncate"
            />
            <button
              onClick={() => copyToClipboard(inviteUrl)}
              className="px-4 py-3 border border-white/20 dark:border-gray-600 rounded-lg hover:bg-gray-800/5 dark:hover:bg-gray-800 transition-colors"
            >
