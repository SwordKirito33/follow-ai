        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            ...
            className={cn(
              ...
              i <= strength.score ? colorClasses[strength.color] : 'bg-slate-800/50/10 dark:bg-gray-700'
            )}
          />
        ))}
      </div>
    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 gap-3">
        <button
          ...
          disabled={isLoading}
          className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg border border-white/10 dark:border-gray-700 bg-slate-800/50 dark:bg-gray-800 hover:bg-slate-800/50/5 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
        >
