    ...
    <div
      className={cn(
        ...
        isLocked
          ...
          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-lg'
      )}
    >
      {/* Lock Overlay */}
      {isLocked && (
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="flex items-center gap-1 px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30">
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
          <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{stats.totalXp}</div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-gray-600 dark:text-gray-400">显示已完成</span>
          </label>
        </div>
      </div>
