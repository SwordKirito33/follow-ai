    ...
    <div className="min-h-screen py-12 px-4 relative">
      ...
      <div className="container mx-auto max-w-4xl space-y-6 relative z-10">
        <header className="animate-slideDown">
          ...
          <p className="text-gray-400 mt-2">{t('terms.lastUpdated')}</p>
        </header>

        <section className="glass-card rounded-2xl shadow-xl p-6 space-y-3 text-sm text-gray-300 leading-relaxed animate-slideUp">
