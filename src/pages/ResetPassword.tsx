...
const ResetPassword: React.FC = () => {
  ...
  if (!isValidToken) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-transparent px-4">
        <div className="bg-slate-800/50 dark:bg-gray-900 rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transparent px-4 py-12">
      <div className="bg-slate-800/50 dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-md">
        {/* Header */}
        <div className="p-6 border-b border-white/10 dark:border-gray-700">
          <h1 className="text-2xl font-black text-white dark:text-white tracking-tight">
            Set New Password
          </h1>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 border border-white/20 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-slate-800/50 dark:bg-gray-800 text-white dark:text-white"
