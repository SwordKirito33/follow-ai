export const en = {
  ...
  settingsPage: {
    ...
    profilePhotoHint: 'Click on the avatar to upload a new photo',
    ...
    language: 'Language',
    font: 'Font',
    billingSettings: 'Billing & Payments',
  ...
  xpHistoryPage: {
    title: 'XP History',
    subtitle: 'Track all your XP gains and achievements',
    totalXp: 'Total XP',
    currentLevelXp: 'Current Level XP',
    totalEvents: 'Total Events',
    loading: 'Loading XP history...',
    noEvents: 'No XP events yet',
    noEventsDesc: 'Complete tasks and activities to start earning XP!',
    loadMore: 'Load More',
    pleaseLogin: 'Please Log In',
    loginRequired: 'You need to be logged in to view your XP history.',
    error: 'Error',
  },
  ...
  leaderboardPage: {
    title: 'Leaderboard',
    subtitle: 'See who\'s leading the AI tool benchmark and earning the most rewards',
    allTimeContributors: 'All-Time Top Contributors',
    weeklyContributors: 'Top Contributors (Week)',
    weeklyTools: 'Top Tools (Week)',
    ...
    verifiedOutputsWeek: 'verified outputs this week',
    error: 'Error',
  },
