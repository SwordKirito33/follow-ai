...
**确保这一行正确：**
```env
VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5idm5uaG9qdmt4Zm5pZGlkYXN0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU3MTI2ODksImV4cCI6MjA4MTI4ODY4OX0.vkVTWvkwh7M0FtFLaupbpFaHQinr9aoW3O0pUx-v7UI
```
